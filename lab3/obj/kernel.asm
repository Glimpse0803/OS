...
ffffffffc0200072:	35e000ef          	jal	ra,ffffffffc02003d0 <ide_init>
    swap_init();                // init swap
ffffffffc0200076:	1c3020ef          	jal	ra,ffffffffc0202a38 <swap_init>
...
ffffffffc02001ae:	3c258593          	addi	a1,a1,962 # ffffffffc021156c <end>
...
ffffffffc02001c2:	7ad58593          	addi	a1,a1,1965 # ffffffffc021196b <end+0x3ff>
...
ffffffffc02002d2:	7ba90913          	addi	s2,s2,1978 # ffffffffc0205a88 <commands+0x1438>
...
ffffffffc0200b0a:	a62a8a93          	addi	s5,s5,-1438 # ffffffffc0211568 <swap_init_ok>
...
ffffffffc0200b3c:	57e020ef          	jal	ra,ffffffffc02030ba <swap_out>
    if (read_csr(sstatus) & SSTATUS_SIE) {
...
ffffffffc0201084:	4eb78793          	addi	a5,a5,1259 # ffffffffc021256b <end+0xfff>
...
ffffffffc02013aa:	0007b023          	sd	zero,0(a5) # fffffffffffff000 <end+0x3fdeda94>
...
ffffffffc020144e:	64051e63          	bnez	a0,ffffffffc0201aaa <pmm_init+0xacc>
    assert(page_ref(p) == 1);
ffffffffc0201452:	000aa703          	lw	a4,0(s5) # fffffffffffff000 <end+0x3fdeda94>
...
ffffffffc02014ca:	10068023          	sb	zero,256(a3) # fffffffffff80100 <end+0x3fd6eb94>
    assert(strlen((const char *)0x100) == 0);
...
ffffffffc0201c16:	9567a783          	lw	a5,-1706(a5) # ffffffffc0211568 <swap_init_ok>
...
ffffffffc0201c3a:	474010ef          	jal	ra,ffffffffc02030ae <swap_map_swappable>
...
ffffffffc0201e8c:	6e07a783          	lw	a5,1760(a5) # ffffffffc0211568 <swap_init_ok>
...
ffffffffc0201e9e:	8082                	ret
        if (swap_init_ok) swap_init_mm(mm);//页面置换的初始化
ffffffffc0201ea0:	202010ef          	jal	ra,ffffffffc02030a2 <swap_init_mm>
}
...
ffffffffc0202060:	50c7a783          	lw	a5,1292(a5) # ffffffffc0211568 <swap_init_ok>
...
ffffffffc02020b0:	852fe0ef          	jal	ra,ffffffffc0200102 <__panic>
        if (swap_init_ok) swap_init_mm(mm);//页面置换的初始化
ffffffffc02020b4:	7ef000ef          	jal	ra,ffffffffc02030a2 <swap_init_mm>
...
ffffffffc020223e:	32e7a783          	lw	a5,814(a5) # ffffffffc0211568 <swap_init_ok>
    elm->prev = elm->next = elm;
...
ffffffffc020238e:	d2dfd06f          	j	ffffffffc02000ba <cprintf>
        if (swap_init_ok) swap_init_mm(mm);//页面置换的初始化
ffffffffc0202392:	511000ef          	jal	ra,ffffffffc02030a2 <swap_init_mm>
...
ffffffffc0202644:	f287a783          	lw	a5,-216(a5) # ffffffffc0211568 <swap_init_ok>
...
ffffffffc0202650:	e402                	sd	zero,8(sp)
            swap_in(mm,addr,&page);
ffffffffc0202652:	37d000ef          	jal	ra,ffffffffc02031ce <swap_in>
...
ffffffffc020266a:	245000ef          	jal	ra,ffffffffc02030ae <swap_map_swappable>
...
ffffffffc02026c6 <_clock_init_mm>:
    elm->prev = elm->next = elm;
ffffffffc02026c6:	0000f797          	auipc	a5,0xf
ffffffffc02026ca:	97a78793          	addi	a5,a5,-1670 # ffffffffc0211040 <pra_list_head>
...
ffffffffc02026ce:	f51c                	sd	a5,40(a0)
ffffffffc02026d0:	e79c                	sd	a5,8(a5)
ffffffffc02026d2:	e39c                	sd	a5,0(a5)
    curr_ptr = &pra_list_head;
ffffffffc02026d4:	0000f717          	auipc	a4,0xf
ffffffffc02026d8:	e6f73e23          	sd	a5,-388(a4) # ffffffffc0211550 <curr_ptr>
...
ffffffffc02026e4 <_clock_set_unswappable>:
...
ffffffffc02026e4:	4501                	li	a0,0
ffffffffc02026e6:	8082                	ret

ffffffffc02026e8 <_clock_tick_event>:
...
ffffffffc02026ec <_clock_check_swap>:
_clock_check_swap(void) {
ffffffffc02026ec:	1141                	addi	sp,sp,-16
    *(unsigned char *)0x3000 = 0x0c;
ffffffffc02026ee:	4731                	li	a4,12
_clock_check_swap(void) {
ffffffffc02026f0:	e406                	sd	ra,8(sp)
    *(unsigned char *)0x3000 = 0x0c;
ffffffffc02026f2:	678d                	lui	a5,0x3
ffffffffc02026f4:	00e78023          	sb	a4,0(a5) # 3000 <kern_entry-0xffffffffc01fd000>
    assert(pgfault_num==4);
ffffffffc02026f8:	0000f697          	auipc	a3,0xf
ffffffffc02026fc:	e506a683          	lw	a3,-432(a3) # ffffffffc0211548 <pgfault_num>
ffffffffc0202700:	4711                	li	a4,4
ffffffffc0202702:	0ae69363          	bne	a3,a4,ffffffffc02027a8 <_clock_check_swap+0xbc>
    *(unsigned char *)0x1000 = 0x0a;
ffffffffc0202706:	6705                	lui	a4,0x1
ffffffffc0202708:	4629                	li	a2,10
ffffffffc020270a:	0000f797          	auipc	a5,0xf
ffffffffc020270e:	e3e78793          	addi	a5,a5,-450 # ffffffffc0211548 <pgfault_num>
ffffffffc0202712:	00c70023          	sb	a2,0(a4) # 1000 <kern_entry-0xffffffffc01ff000>
    assert(pgfault_num==4);
ffffffffc0202716:	4398                	lw	a4,0(a5)
ffffffffc0202718:	2701                	sext.w	a4,a4
ffffffffc020271a:	20d71763          	bne	a4,a3,ffffffffc0202928 <_clock_check_swap+0x23c>
    *(unsigned char *)0x4000 = 0x0d;
ffffffffc020271e:	6691                	lui	a3,0x4
ffffffffc0202720:	4635                	li	a2,13
ffffffffc0202722:	00c68023          	sb	a2,0(a3) # 4000 <kern_entry-0xffffffffc01fc000>
    assert(pgfault_num==4);
ffffffffc0202726:	4394                	lw	a3,0(a5)
ffffffffc0202728:	2681                	sext.w	a3,a3
ffffffffc020272a:	1ce69f63          	bne	a3,a4,ffffffffc0202908 <_clock_check_swap+0x21c>
    *(unsigned char *)0x2000 = 0x0b;
ffffffffc020272e:	6709                	lui	a4,0x2
ffffffffc0202730:	462d                	li	a2,11
ffffffffc0202732:	00c70023          	sb	a2,0(a4) # 2000 <kern_entry-0xffffffffc01fe000>
    assert(pgfault_num==4);
ffffffffc0202736:	4398                	lw	a4,0(a5)
ffffffffc0202738:	2701                	sext.w	a4,a4
ffffffffc020273a:	1ad71763          	bne	a4,a3,ffffffffc02028e8 <_clock_check_swap+0x1fc>
    *(unsigned char *)0x5000 = 0x0e;
ffffffffc020273e:	6715                	lui	a4,0x5
ffffffffc0202740:	46b9                	li	a3,14
ffffffffc0202742:	00d70023          	sb	a3,0(a4) # 5000 <kern_entry-0xffffffffc01fb000>
    assert(pgfault_num==5);
ffffffffc0202746:	4398                	lw	a4,0(a5)
ffffffffc0202748:	4695                	li	a3,5
ffffffffc020274a:	2701                	sext.w	a4,a4
ffffffffc020274c:	16d71e63          	bne	a4,a3,ffffffffc02028c8 <_clock_check_swap+0x1dc>
    assert(pgfault_num==5);
ffffffffc0202750:	4394                	lw	a3,0(a5)
ffffffffc0202752:	2681                	sext.w	a3,a3
ffffffffc0202754:	14e69a63          	bne	a3,a4,ffffffffc02028a8 <_clock_check_swap+0x1bc>
    assert(pgfault_num==5);
ffffffffc0202758:	4398                	lw	a4,0(a5)
ffffffffc020275a:	2701                	sext.w	a4,a4
ffffffffc020275c:	12d71663          	bne	a4,a3,ffffffffc0202888 <_clock_check_swap+0x19c>
    assert(pgfault_num==5);
ffffffffc0202760:	4394                	lw	a3,0(a5)
ffffffffc0202762:	2681                	sext.w	a3,a3
ffffffffc0202764:	10e69263          	bne	a3,a4,ffffffffc0202868 <_clock_check_swap+0x17c>
    assert(pgfault_num==5);
ffffffffc0202768:	4398                	lw	a4,0(a5)
ffffffffc020276a:	2701                	sext.w	a4,a4
ffffffffc020276c:	0cd71e63          	bne	a4,a3,ffffffffc0202848 <_clock_check_swap+0x15c>
    assert(pgfault_num==5);
ffffffffc0202770:	4394                	lw	a3,0(a5)
ffffffffc0202772:	2681                	sext.w	a3,a3
ffffffffc0202774:	0ae69a63          	bne	a3,a4,ffffffffc0202828 <_clock_check_swap+0x13c>
    *(unsigned char *)0x5000 = 0x0e;
ffffffffc0202778:	6715                	lui	a4,0x5
ffffffffc020277a:	46b9                	li	a3,14
ffffffffc020277c:	00d70023          	sb	a3,0(a4) # 5000 <kern_entry-0xffffffffc01fb000>
    assert(pgfault_num==5);
ffffffffc0202780:	4398                	lw	a4,0(a5)
ffffffffc0202782:	4695                	li	a3,5
ffffffffc0202784:	2701                	sext.w	a4,a4
ffffffffc0202786:	08d71163          	bne	a4,a3,ffffffffc0202808 <_clock_check_swap+0x11c>
    assert(*(unsigned char *)0x1000 == 0x0a);
ffffffffc020278a:	6705                	lui	a4,0x1
ffffffffc020278c:	00074683          	lbu	a3,0(a4) # 1000 <kern_entry-0xffffffffc01ff000>
ffffffffc0202790:	4729                	li	a4,10
ffffffffc0202792:	04e69b63          	bne	a3,a4,ffffffffc02027e8 <_clock_check_swap+0xfc>
    assert(pgfault_num==6);
ffffffffc0202796:	439c                	lw	a5,0(a5)
ffffffffc0202798:	4719                	li	a4,6
ffffffffc020279a:	2781                	sext.w	a5,a5
ffffffffc020279c:	02e79663          	bne	a5,a4,ffffffffc02027c8 <_clock_check_swap+0xdc>
}
ffffffffc02027a0:	60a2                	ld	ra,8(sp)
ffffffffc02027a2:	4501                	li	a0,0
ffffffffc02027a4:	0141                	addi	sp,sp,16
ffffffffc02027a6:	8082                	ret
    assert(pgfault_num==4);
ffffffffc02027a8:	00003697          	auipc	a3,0x3
ffffffffc02027ac:	f6068693          	addi	a3,a3,-160 # ffffffffc0205708 <commands+0x10b8>
ffffffffc02027b0:	00002617          	auipc	a2,0x2
ffffffffc02027b4:	72860613          	addi	a2,a2,1832 # ffffffffc0204ed8 <commands+0x888>
ffffffffc02027b8:	09100593          	li	a1,145
ffffffffc02027bc:	00003517          	auipc	a0,0x3
ffffffffc02027c0:	f5c50513          	addi	a0,a0,-164 # ffffffffc0205718 <commands+0x10c8>
ffffffffc02027c4:	93ffd0ef          	jal	ra,ffffffffc0200102 <__panic>
    assert(pgfault_num==6);
ffffffffc02027c8:	00003697          	auipc	a3,0x3
ffffffffc02027cc:	fa068693          	addi	a3,a3,-96 # ffffffffc0205768 <commands+0x1118>
ffffffffc02027d0:	00002617          	auipc	a2,0x2
ffffffffc02027d4:	70860613          	addi	a2,a2,1800 # ffffffffc0204ed8 <commands+0x888>
ffffffffc02027d8:	0a800593          	li	a1,168
ffffffffc02027dc:	00003517          	auipc	a0,0x3
ffffffffc02027e0:	f3c50513          	addi	a0,a0,-196 # ffffffffc0205718 <commands+0x10c8>
ffffffffc02027e4:	91ffd0ef          	jal	ra,ffffffffc0200102 <__panic>
    assert(*(unsigned char *)0x1000 == 0x0a);
ffffffffc02027e8:	00003697          	auipc	a3,0x3
ffffffffc02027ec:	f5868693          	addi	a3,a3,-168 # ffffffffc0205740 <commands+0x10f0>
ffffffffc02027f0:	00002617          	auipc	a2,0x2
ffffffffc02027f4:	6e860613          	addi	a2,a2,1768 # ffffffffc0204ed8 <commands+0x888>
ffffffffc02027f8:	0a600593          	li	a1,166
ffffffffc02027fc:	00003517          	auipc	a0,0x3
ffffffffc0202800:	f1c50513          	addi	a0,a0,-228 # ffffffffc0205718 <commands+0x10c8>
ffffffffc0202804:	8fffd0ef          	jal	ra,ffffffffc0200102 <__panic>
    assert(pgfault_num==5);
ffffffffc0202808:	00003697          	auipc	a3,0x3
ffffffffc020280c:	f2868693          	addi	a3,a3,-216 # ffffffffc0205730 <commands+0x10e0>
ffffffffc0202810:	00002617          	auipc	a2,0x2
ffffffffc0202814:	6c860613          	addi	a2,a2,1736 # ffffffffc0204ed8 <commands+0x888>
ffffffffc0202818:	0a500593          	li	a1,165
ffffffffc020281c:	00003517          	auipc	a0,0x3
ffffffffc0202820:	efc50513          	addi	a0,a0,-260 # ffffffffc0205718 <commands+0x10c8>
ffffffffc0202824:	8dffd0ef          	jal	ra,ffffffffc0200102 <__panic>
    assert(pgfault_num==5);
ffffffffc0202828:	00003697          	auipc	a3,0x3
ffffffffc020282c:	f0868693          	addi	a3,a3,-248 # ffffffffc0205730 <commands+0x10e0>
ffffffffc0202830:	00002617          	auipc	a2,0x2
ffffffffc0202834:	6a860613          	addi	a2,a2,1704 # ffffffffc0204ed8 <commands+0x888>
ffffffffc0202838:	0a300593          	li	a1,163
ffffffffc020283c:	00003517          	auipc	a0,0x3
ffffffffc0202840:	edc50513          	addi	a0,a0,-292 # ffffffffc0205718 <commands+0x10c8>
ffffffffc0202844:	8bffd0ef          	jal	ra,ffffffffc0200102 <__panic>
    assert(pgfault_num==5);
ffffffffc0202848:	00003697          	auipc	a3,0x3
ffffffffc020284c:	ee868693          	addi	a3,a3,-280 # ffffffffc0205730 <commands+0x10e0>
ffffffffc0202850:	00002617          	auipc	a2,0x2
ffffffffc0202854:	68860613          	addi	a2,a2,1672 # ffffffffc0204ed8 <commands+0x888>
ffffffffc0202858:	0a100593          	li	a1,161
ffffffffc020285c:	00003517          	auipc	a0,0x3
ffffffffc0202860:	ebc50513          	addi	a0,a0,-324 # ffffffffc0205718 <commands+0x10c8>
ffffffffc0202864:	89ffd0ef          	jal	ra,ffffffffc0200102 <__panic>
    assert(pgfault_num==5);
ffffffffc0202868:	00003697          	auipc	a3,0x3
ffffffffc020286c:	ec868693          	addi	a3,a3,-312 # ffffffffc0205730 <commands+0x10e0>
ffffffffc0202870:	00002617          	auipc	a2,0x2
ffffffffc0202874:	66860613          	addi	a2,a2,1640 # ffffffffc0204ed8 <commands+0x888>
ffffffffc0202878:	09f00593          	li	a1,159
ffffffffc020287c:	00003517          	auipc	a0,0x3
ffffffffc0202880:	e9c50513          	addi	a0,a0,-356 # ffffffffc0205718 <commands+0x10c8>
ffffffffc0202884:	87ffd0ef          	jal	ra,ffffffffc0200102 <__panic>
    assert(pgfault_num==5);
ffffffffc0202888:	00003697          	auipc	a3,0x3
ffffffffc020288c:	ea868693          	addi	a3,a3,-344 # ffffffffc0205730 <commands+0x10e0>
ffffffffc0202890:	00002617          	auipc	a2,0x2
ffffffffc0202894:	64860613          	addi	a2,a2,1608 # ffffffffc0204ed8 <commands+0x888>
ffffffffc0202898:	09d00593          	li	a1,157
ffffffffc020289c:	00003517          	auipc	a0,0x3
ffffffffc02028a0:	e7c50513          	addi	a0,a0,-388 # ffffffffc0205718 <commands+0x10c8>
ffffffffc02028a4:	85ffd0ef          	jal	ra,ffffffffc0200102 <__panic>
    assert(pgfault_num==5);
ffffffffc02028a8:	00003697          	auipc	a3,0x3
ffffffffc02028ac:	e8868693          	addi	a3,a3,-376 # ffffffffc0205730 <commands+0x10e0>
ffffffffc02028b0:	00002617          	auipc	a2,0x2
ffffffffc02028b4:	62860613          	addi	a2,a2,1576 # ffffffffc0204ed8 <commands+0x888>
ffffffffc02028b8:	09b00593          	li	a1,155
ffffffffc02028bc:	00003517          	auipc	a0,0x3
ffffffffc02028c0:	e5c50513          	addi	a0,a0,-420 # ffffffffc0205718 <commands+0x10c8>
ffffffffc02028c4:	83ffd0ef          	jal	ra,ffffffffc0200102 <__panic>
    assert(pgfault_num==5);
ffffffffc02028c8:	00003697          	auipc	a3,0x3
ffffffffc02028cc:	e6868693          	addi	a3,a3,-408 # ffffffffc0205730 <commands+0x10e0>
ffffffffc02028d0:	00002617          	auipc	a2,0x2
ffffffffc02028d4:	60860613          	addi	a2,a2,1544 # ffffffffc0204ed8 <commands+0x888>
ffffffffc02028d8:	09900593          	li	a1,153
ffffffffc02028dc:	00003517          	auipc	a0,0x3
ffffffffc02028e0:	e3c50513          	addi	a0,a0,-452 # ffffffffc0205718 <commands+0x10c8>
ffffffffc02028e4:	81ffd0ef          	jal	ra,ffffffffc0200102 <__panic>
    assert(pgfault_num==4);
ffffffffc02028e8:	00003697          	auipc	a3,0x3
ffffffffc02028ec:	e2068693          	addi	a3,a3,-480 # ffffffffc0205708 <commands+0x10b8>
ffffffffc02028f0:	00002617          	auipc	a2,0x2
ffffffffc02028f4:	5e860613          	addi	a2,a2,1512 # ffffffffc0204ed8 <commands+0x888>
ffffffffc02028f8:	09700593          	li	a1,151
ffffffffc02028fc:	00003517          	auipc	a0,0x3
ffffffffc0202900:	e1c50513          	addi	a0,a0,-484 # ffffffffc0205718 <commands+0x10c8>
ffffffffc0202904:	ffefd0ef          	jal	ra,ffffffffc0200102 <__panic>
    assert(pgfault_num==4);
ffffffffc0202908:	00003697          	auipc	a3,0x3
ffffffffc020290c:	e0068693          	addi	a3,a3,-512 # ffffffffc0205708 <commands+0x10b8>
ffffffffc0202910:	00002617          	auipc	a2,0x2
ffffffffc0202914:	5c860613          	addi	a2,a2,1480 # ffffffffc0204ed8 <commands+0x888>
ffffffffc0202918:	09500593          	li	a1,149
ffffffffc020291c:	00003517          	auipc	a0,0x3
ffffffffc0202920:	dfc50513          	addi	a0,a0,-516 # ffffffffc0205718 <commands+0x10c8>
ffffffffc0202924:	fdefd0ef          	jal	ra,ffffffffc0200102 <__panic>
    assert(pgfault_num==4);
ffffffffc0202928:	00003697          	auipc	a3,0x3
ffffffffc020292c:	de068693          	addi	a3,a3,-544 # ffffffffc0205708 <commands+0x10b8>
ffffffffc0202930:	00002617          	auipc	a2,0x2
ffffffffc0202934:	5a860613          	addi	a2,a2,1448 # ffffffffc0204ed8 <commands+0x888>
ffffffffc0202938:	09300593          	li	a1,147
ffffffffc020293c:	00003517          	auipc	a0,0x3
ffffffffc0202940:	ddc50513          	addi	a0,a0,-548 # ffffffffc0205718 <commands+0x10c8>
ffffffffc0202944:	fbefd0ef          	jal	ra,ffffffffc0200102 <__panic>

ffffffffc0202948 <_clock_swap_out_victim>:
     list_entry_t *head=(list_entry_t*) mm->sm_priv;
ffffffffc0202948:	7514                	ld	a3,40(a0)
{
ffffffffc020294a:	1141                	addi	sp,sp,-16
ffffffffc020294c:	e406                	sd	ra,8(sp)
        assert(head != NULL);
ffffffffc020294e:	c2d1                	beqz	a3,ffffffffc02029d2 <_clock_swap_out_victim+0x8a>
    assert(in_tick==0);
ffffffffc0202950:	e22d                	bnez	a2,ffffffffc02029b2 <_clock_swap_out_victim+0x6a>
    return listelm->next;
ffffffffc0202952:	0000f617          	auipc	a2,0xf
ffffffffc0202956:	bfe60613          	addi	a2,a2,-1026 # ffffffffc0211550 <curr_ptr>
ffffffffc020295a:	621c                	ld	a5,0(a2)
ffffffffc020295c:	852e                	mv	a0,a1
ffffffffc020295e:	678c                	ld	a1,8(a5)
ffffffffc0202960:	a039                	j	ffffffffc020296e <_clock_swap_out_victim+0x26>
        if(!page->visited) {
ffffffffc0202962:	fe05b703          	ld	a4,-32(a1) # ffffffffffffefe0 <end+0x3fdeda74>
ffffffffc0202966:	cf11                	beqz	a4,ffffffffc0202982 <_clock_swap_out_victim+0x3a>
            page->visited = 0;
ffffffffc0202968:	fe05b023          	sd	zero,-32(a1)
    while (1) {
ffffffffc020296c:	85be                	mv	a1,a5
ffffffffc020296e:	659c                	ld	a5,8(a1)
        if(curr_ptr == head) {
ffffffffc0202970:	feb699e3          	bne	a3,a1,ffffffffc0202962 <_clock_swap_out_victim+0x1a>
            if(curr_ptr == head) {
ffffffffc0202974:	02d78863          	beq	a5,a3,ffffffffc02029a4 <_clock_swap_out_victim+0x5c>
    __list_del(listelm->prev, listelm->next);
ffffffffc0202978:	85be                	mv	a1,a5
        if(!page->visited) {
ffffffffc020297a:	fe05b703          	ld	a4,-32(a1)
ffffffffc020297e:	679c                	ld	a5,8(a5)
ffffffffc0202980:	f765                	bnez	a4,ffffffffc0202968 <_clock_swap_out_victim+0x20>
ffffffffc0202982:	6198                	ld	a4,0(a1)
        struct Page* page = le2page(curr_ptr, pra_page_link);
ffffffffc0202984:	fd058693          	addi	a3,a1,-48
ffffffffc0202988:	e20c                	sd	a1,0(a2)
            *ptr_page = page;
ffffffffc020298a:	e114                	sd	a3,0(a0)
    prev->next = next;
ffffffffc020298c:	e71c                	sd	a5,8(a4)
    next->prev = prev;
ffffffffc020298e:	e398                	sd	a4,0(a5)
            cprintf("curr_ptr %p\n",curr_ptr);
ffffffffc0202990:	00003517          	auipc	a0,0x3
ffffffffc0202994:	e0850513          	addi	a0,a0,-504 # ffffffffc0205798 <commands+0x1148>
ffffffffc0202998:	f22fd0ef          	jal	ra,ffffffffc02000ba <cprintf>
}
ffffffffc020299c:	60a2                	ld	ra,8(sp)
ffffffffc020299e:	4501                	li	a0,0
ffffffffc02029a0:	0141                	addi	sp,sp,16
ffffffffc02029a2:	8082                	ret
ffffffffc02029a4:	60a2                	ld	ra,8(sp)
ffffffffc02029a6:	e214                	sd	a3,0(a2)
                *ptr_page = NULL;
ffffffffc02029a8:	00053023          	sd	zero,0(a0)
}
ffffffffc02029ac:	4501                	li	a0,0
ffffffffc02029ae:	0141                	addi	sp,sp,16
ffffffffc02029b0:	8082                	ret
    assert(in_tick==0);
ffffffffc02029b2:	00003697          	auipc	a3,0x3
ffffffffc02029b6:	dd668693          	addi	a3,a3,-554 # ffffffffc0205788 <commands+0x1138>
ffffffffc02029ba:	00002617          	auipc	a2,0x2
ffffffffc02029be:	51e60613          	addi	a2,a2,1310 # ffffffffc0204ed8 <commands+0x888>
ffffffffc02029c2:	04c00593          	li	a1,76
ffffffffc02029c6:	00003517          	auipc	a0,0x3
ffffffffc02029ca:	d5250513          	addi	a0,a0,-686 # ffffffffc0205718 <commands+0x10c8>
ffffffffc02029ce:	f34fd0ef          	jal	ra,ffffffffc0200102 <__panic>
        assert(head != NULL);
ffffffffc02029d2:	00003697          	auipc	a3,0x3
ffffffffc02029d6:	da668693          	addi	a3,a3,-602 # ffffffffc0205778 <commands+0x1128>
ffffffffc02029da:	00002617          	auipc	a2,0x2
ffffffffc02029de:	4fe60613          	addi	a2,a2,1278 # ffffffffc0204ed8 <commands+0x888>
ffffffffc02029e2:	04b00593          	li	a1,75
ffffffffc02029e6:	00003517          	auipc	a0,0x3
ffffffffc02029ea:	d3250513          	addi	a0,a0,-718 # ffffffffc0205718 <commands+0x10c8>
ffffffffc02029ee:	f14fd0ef          	jal	ra,ffffffffc0200102 <__panic>

ffffffffc02029f2 <_clock_map_swappable>:
    assert(entry != NULL && curr_ptr != NULL);
ffffffffc02029f2:	0000f797          	auipc	a5,0xf
ffffffffc02029f6:	b5e7b783          	ld	a5,-1186(a5) # ffffffffc0211550 <curr_ptr>
ffffffffc02029fa:	cf89                	beqz	a5,ffffffffc0202a14 <_clock_map_swappable+0x22>
    list_add_before((list_entry_t*) mm->sm_priv,entry);
ffffffffc02029fc:	751c                	ld	a5,40(a0)
ffffffffc02029fe:	03060713          	addi	a4,a2,48
}
ffffffffc0202a02:	4501                	li	a0,0
    __list_add(elm, listelm->prev, listelm);
ffffffffc0202a04:	6394                	ld	a3,0(a5)
    prev->next = next->prev = elm;
ffffffffc0202a06:	e398                	sd	a4,0(a5)
ffffffffc0202a08:	e698                	sd	a4,8(a3)
    elm->next = next;
ffffffffc0202a0a:	fe1c                	sd	a5,56(a2)
    page->visited = 1;
ffffffffc0202a0c:	4785                	li	a5,1
    elm->prev = prev;
ffffffffc0202a0e:	fa14                	sd	a3,48(a2)
ffffffffc0202a10:	ea1c                	sd	a5,16(a2)
}
ffffffffc0202a12:	8082                	ret
{
ffffffffc0202a14:	1141                	addi	sp,sp,-16
    assert(entry != NULL && curr_ptr != NULL);
ffffffffc0202a16:	00003697          	auipc	a3,0x3
ffffffffc0202a1a:	d9268693          	addi	a3,a3,-622 # ffffffffc02057a8 <commands+0x1158>
ffffffffc0202a1e:	00002617          	auipc	a2,0x2
ffffffffc0202a22:	4ba60613          	addi	a2,a2,1210 # ffffffffc0204ed8 <commands+0x888>
ffffffffc0202a26:	03800593          	li	a1,56
ffffffffc0202a2a:	00003517          	auipc	a0,0x3
ffffffffc0202a2e:	cee50513          	addi	a0,a0,-786 # ffffffffc0205718 <commands+0x10c8>
{
ffffffffc0202a32:	e406                	sd	ra,8(sp)
    assert(entry != NULL && curr_ptr != NULL);
ffffffffc0202a34:	ecefd0ef          	jal	ra,ffffffffc0200102 <__panic>

ffffffffc0202a38 <swap_init>:
...
swap_init(void)
{
ffffffffc0202a38:	7135                	addi	sp,sp,-160
ffffffffc0202a3a:	ed06                	sd	ra,152(sp)
ffffffffc0202a3c:	e922                	sd	s0,144(sp)
ffffffffc0202a3e:	e526                	sd	s1,136(sp)
ffffffffc0202a40:	e14a                	sd	s2,128(sp)
ffffffffc0202a42:	fcce                	sd	s3,120(sp)
ffffffffc0202a44:	f8d2                	sd	s4,112(sp)
ffffffffc0202a46:	f4d6                	sd	s5,104(sp)
ffffffffc0202a48:	f0da                	sd	s6,96(sp)
ffffffffc0202a4a:	ecde                	sd	s7,88(sp)
ffffffffc0202a4c:	e8e2                	sd	s8,80(sp)
ffffffffc0202a4e:	e4e6                	sd	s9,72(sp)
ffffffffc0202a50:	e0ea                	sd	s10,64(sp)
ffffffffc0202a52:	fc6e                	sd	s11,56(sp)
     swapfs_init();
ffffffffc0202a54:	2cc010ef          	jal	ra,ffffffffc0203d20 <swapfs_init>

     // Since the IDE is faked, it can only store 7 pages at most to pass the test
     if (!(7 <= max_swap_offset &&
ffffffffc0202a58:	0000f697          	auipc	a3,0xf
ffffffffc0202a5c:	b006b683          	ld	a3,-1280(a3) # ffffffffc0211558 <max_swap_offset>
ffffffffc0202a60:	010007b7          	lui	a5,0x1000
ffffffffc0202a64:	ff968713          	addi	a4,a3,-7
ffffffffc0202a68:	17e1                	addi	a5,a5,-8
ffffffffc0202a6a:	3ee7e063          	bltu	a5,a4,ffffffffc0202e4a <swap_init+0x412>
        max_swap_offset < MAX_SWAP_OFFSET_LIMIT)) {
        panic("bad max_swap_offset %08x.\n", max_swap_offset);
     }

     sm = &swap_manager_clock;//use first in first out Page Replacement Algorithm
ffffffffc0202a6e:	00007797          	auipc	a5,0x7
ffffffffc0202a72:	59278793          	addi	a5,a5,1426 # ffffffffc020a000 <swap_manager_clock>
     int r = sm->init();
ffffffffc0202a76:	6798                	ld	a4,8(a5)
     sm = &swap_manager_clock;//use first in first out Page Replacement Algorithm
ffffffffc0202a78:	0000fb17          	auipc	s6,0xf
ffffffffc0202a7c:	ae8b0b13          	addi	s6,s6,-1304 # ffffffffc0211560 <sm>
ffffffffc0202a80:	00fb3023          	sd	a5,0(s6)
     int r = sm->init();
ffffffffc0202a84:	9702                	jalr	a4
ffffffffc0202a86:	89aa                	mv	s3,a0
     
     if (r == 0)
ffffffffc0202a88:	c10d                	beqz	a0,ffffffffc0202aaa <swap_init+0x72>
...
ffffffffc0202a8a:	60ea                	ld	ra,152(sp)
ffffffffc0202a8c:	644a                	ld	s0,144(sp)
ffffffffc0202a8e:	64aa                	ld	s1,136(sp)
ffffffffc0202a90:	690a                	ld	s2,128(sp)
ffffffffc0202a92:	7a46                	ld	s4,112(sp)
ffffffffc0202a94:	7aa6                	ld	s5,104(sp)
ffffffffc0202a96:	7b06                	ld	s6,96(sp)
ffffffffc0202a98:	6be6                	ld	s7,88(sp)
ffffffffc0202a9a:	6c46                	ld	s8,80(sp)
ffffffffc0202a9c:	6ca6                	ld	s9,72(sp)
ffffffffc0202a9e:	6d06                	ld	s10,64(sp)
ffffffffc0202aa0:	7de2                	ld	s11,56(sp)
ffffffffc0202aa2:	854e                	mv	a0,s3
ffffffffc0202aa4:	79e6                	ld	s3,120(sp)
ffffffffc0202aa6:	610d                	addi	sp,sp,160
ffffffffc0202aa8:	8082                	ret
          cprintf("SWAP: manager = %s\n", sm->name);
ffffffffc0202aaa:	000b3783          	ld	a5,0(s6)
ffffffffc0202aae:	00003517          	auipc	a0,0x3
ffffffffc0202ab2:	d6a50513          	addi	a0,a0,-662 # ffffffffc0205818 <commands+0x11c8>
    return listelm->next;
ffffffffc0202ab6:	0000e497          	auipc	s1,0xe
ffffffffc0202aba:	62a48493          	addi	s1,s1,1578 # ffffffffc02110e0 <free_area>
ffffffffc0202abe:	638c                	ld	a1,0(a5)
          swap_init_ok = 1;
ffffffffc0202ac0:	4785                	li	a5,1
ffffffffc0202ac2:	0000f717          	auipc	a4,0xf
ffffffffc0202ac6:	aaf72323          	sw	a5,-1370(a4) # ffffffffc0211568 <swap_init_ok>
          cprintf("SWAP: manager = %s\n", sm->name);
ffffffffc0202aca:	df0fd0ef          	jal	ra,ffffffffc02000ba <cprintf>
ffffffffc0202ace:	649c                	ld	a5,8(s1)
...
ffffffffc0202ad0:	4401                	li	s0,0
ffffffffc0202ad2:	4d01                	li	s10,0
     list_entry_t *le = &free_list;
     while ((le = list_next(le)) != &free_list) {
ffffffffc0202ad4:	2c978163          	beq	a5,s1,ffffffffc0202d96 <swap_init+0x35e>
...
ffffffffc0202ad8:	fe87b703          	ld	a4,-24(a5)
        struct Page *p = le2page(le, page_link);
        assert(PageProperty(p));
ffffffffc0202adc:	8b09                	andi	a4,a4,2
ffffffffc0202ade:	2a070e63          	beqz	a4,ffffffffc0202d9a <swap_init+0x362>
        count ++, total += p->property;
ffffffffc0202ae2:	ff87a703          	lw	a4,-8(a5)
ffffffffc0202ae6:	679c                	ld	a5,8(a5)
ffffffffc0202ae8:	2d05                	addiw	s10,s10,1
ffffffffc0202aea:	9c39                	addw	s0,s0,a4
     while ((le = list_next(le)) != &free_list) {
ffffffffc0202aec:	fe9796e3          	bne	a5,s1,ffffffffc0202ad8 <swap_init+0xa0>
     }
     assert(total == nr_free_pages());
ffffffffc0202af0:	8922                	mv	s2,s0
ffffffffc0202af2:	8c8fe0ef          	jal	ra,ffffffffc0200bba <nr_free_pages>
ffffffffc0202af6:	47251663          	bne	a0,s2,ffffffffc0202f62 <swap_init+0x52a>
     cprintf("BEGIN check_swap: count %d, total %d\n",count,total);
ffffffffc0202afa:	8622                	mv	a2,s0
ffffffffc0202afc:	85ea                	mv	a1,s10
ffffffffc0202afe:	00003517          	auipc	a0,0x3
ffffffffc0202b02:	d6250513          	addi	a0,a0,-670 # ffffffffc0205860 <commands+0x1210>
ffffffffc0202b06:	db4fd0ef          	jal	ra,ffffffffc02000ba <cprintf>
     
     //now we set the phy pages env     
     struct mm_struct *mm = mm_create();
ffffffffc0202b0a:	b5cff0ef          	jal	ra,ffffffffc0201e66 <mm_create>
ffffffffc0202b0e:	8aaa                	mv	s5,a0
     assert(mm != NULL);
ffffffffc0202b10:	52050963          	beqz	a0,ffffffffc0203042 <swap_init+0x60a>

     extern struct mm_struct *check_mm_struct;
     assert(check_mm_struct == NULL);
ffffffffc0202b14:	0000f797          	auipc	a5,0xf
ffffffffc0202b18:	a2c78793          	addi	a5,a5,-1492 # ffffffffc0211540 <check_mm_struct>
ffffffffc0202b1c:	6398                	ld	a4,0(a5)
ffffffffc0202b1e:	54071263          	bnez	a4,ffffffffc0203062 <swap_init+0x62a>

     check_mm_struct = mm;

     pde_t *pgdir = mm->pgdir = boot_pgdir;
ffffffffc0202b22:	0000fb97          	auipc	s7,0xf
ffffffffc0202b26:	9f6bbb83          	ld	s7,-1546(s7) # ffffffffc0211518 <boot_pgdir>
     assert(pgdir[0] == 0);
ffffffffc0202b2a:	000bb703          	ld	a4,0(s7)
     check_mm_struct = mm;
ffffffffc0202b2e:	e388                	sd	a0,0(a5)
     pde_t *pgdir = mm->pgdir = boot_pgdir;
ffffffffc0202b30:	01753c23          	sd	s7,24(a0)
     assert(pgdir[0] == 0);
ffffffffc0202b34:	3c071763          	bnez	a4,ffffffffc0202f02 <swap_init+0x4ca>

     struct vma_struct *vma = vma_create(BEING_CHECK_VALID_VADDR, CHECK_VALID_VADDR, VM_WRITE | VM_READ);
ffffffffc0202b38:	6599                	lui	a1,0x6
ffffffffc0202b3a:	460d                	li	a2,3
ffffffffc0202b3c:	6505                	lui	a0,0x1
ffffffffc0202b3e:	b70ff0ef          	jal	ra,ffffffffc0201eae <vma_create>
ffffffffc0202b42:	85aa                	mv	a1,a0
     assert(vma != NULL);
ffffffffc0202b44:	3c050f63          	beqz	a0,ffffffffc0202f22 <swap_init+0x4ea>

     insert_vma_struct(mm, vma);
ffffffffc0202b48:	8556                	mv	a0,s5
ffffffffc0202b4a:	bd2ff0ef          	jal	ra,ffffffffc0201f1c <insert_vma_struct>

     //setup the temp Page Table vaddr 0~4MB
     cprintf("setup Page Table for vaddr 0X1000, so alloc a page\n");
ffffffffc0202b4e:	00003517          	auipc	a0,0x3
ffffffffc0202b52:	d5250513          	addi	a0,a0,-686 # ffffffffc02058a0 <commands+0x1250>
ffffffffc0202b56:	d64fd0ef          	jal	ra,ffffffffc02000ba <cprintf>
     pte_t *temp_ptep=NULL;
     temp_ptep = get_pte(mm->pgdir, BEING_CHECK_VALID_VADDR, 1);
ffffffffc0202b5a:	018ab503          	ld	a0,24(s5)
ffffffffc0202b5e:	4605                	li	a2,1
ffffffffc0202b60:	6585                	lui	a1,0x1
ffffffffc0202b62:	892fe0ef          	jal	ra,ffffffffc0200bf4 <get_pte>
     assert(temp_ptep!= NULL);
ffffffffc0202b66:	3c050e63          	beqz	a0,ffffffffc0202f42 <swap_init+0x50a>
     cprintf("setup Page Table vaddr 0~4MB OVER!\n");
ffffffffc0202b6a:	00003517          	auipc	a0,0x3
ffffffffc0202b6e:	d8650513          	addi	a0,a0,-634 # ffffffffc02058f0 <commands+0x12a0>
ffffffffc0202b72:	0000e917          	auipc	s2,0xe
ffffffffc0202b76:	4fe90913          	addi	s2,s2,1278 # ffffffffc0211070 <check_rp>
ffffffffc0202b7a:	d40fd0ef          	jal	ra,ffffffffc02000ba <cprintf>
     
     for (i=0;i<CHECK_VALID_PHY_PAGE_NUM;i++) {
ffffffffc0202b7e:	0000ea17          	auipc	s4,0xe
ffffffffc0202b82:	512a0a13          	addi	s4,s4,1298 # ffffffffc0211090 <swap_in_seq_no>
     cprintf("setup Page Table vaddr 0~4MB OVER!\n");
ffffffffc0202b86:	8c4a                	mv	s8,s2
          check_rp[i] = alloc_page();
ffffffffc0202b88:	4505                	li	a0,1
ffffffffc0202b8a:	f5ffd0ef          	jal	ra,ffffffffc0200ae8 <alloc_pages>
ffffffffc0202b8e:	00ac3023          	sd	a0,0(s8)
          assert(check_rp[i] != NULL );
ffffffffc0202b92:	28050c63          	beqz	a0,ffffffffc0202e2a <swap_init+0x3f2>
ffffffffc0202b96:	651c                	ld	a5,8(a0)
          assert(!PageProperty(check_rp[i]));
ffffffffc0202b98:	8b89                	andi	a5,a5,2
ffffffffc0202b9a:	26079863          	bnez	a5,ffffffffc0202e0a <swap_init+0x3d2>
     for (i=0;i<CHECK_VALID_PHY_PAGE_NUM;i++) {
ffffffffc0202b9e:	0c21                	addi	s8,s8,8
ffffffffc0202ba0:	ff4c14e3          	bne	s8,s4,ffffffffc0202b88 <swap_init+0x150>
     }
     list_entry_t free_list_store = free_list;
ffffffffc0202ba4:	609c                	ld	a5,0(s1)
ffffffffc0202ba6:	0084bd83          	ld	s11,8(s1)
    elm->prev = elm->next = elm;
ffffffffc0202baa:	e084                	sd	s1,0(s1)
ffffffffc0202bac:	f03e                	sd	a5,32(sp)
     list_init(&free_list);
...
ffffffffc0202bae:	489c                	lw	a5,16(s1)
ffffffffc0202bb0:	e484                	sd	s1,8(s1)
     nr_free = 0;
ffffffffc0202bb2:	0000ec17          	auipc	s8,0xe
ffffffffc0202bb6:	4bec0c13          	addi	s8,s8,1214 # ffffffffc0211070 <check_rp>
     unsigned int nr_free_store = nr_free;
ffffffffc0202bba:	f43e                	sd	a5,40(sp)
     nr_free = 0;
ffffffffc0202bbc:	0000e797          	auipc	a5,0xe
ffffffffc0202bc0:	5207aa23          	sw	zero,1332(a5) # ffffffffc02110f0 <free_area+0x10>
     for (i=0;i<CHECK_VALID_PHY_PAGE_NUM;i++) {
        free_pages(check_rp[i],1);
ffffffffc0202bc4:	000c3503          	ld	a0,0(s8)
ffffffffc0202bc8:	4585                	li	a1,1
     for (i=0;i<CHECK_VALID_PHY_PAGE_NUM;i++) {
ffffffffc0202bca:	0c21                	addi	s8,s8,8
        free_pages(check_rp[i],1);
ffffffffc0202bcc:	faffd0ef          	jal	ra,ffffffffc0200b7a <free_pages>
     for (i=0;i<CHECK_VALID_PHY_PAGE_NUM;i++) {
ffffffffc0202bd0:	ff4c1ae3          	bne	s8,s4,ffffffffc0202bc4 <swap_init+0x18c>
     }
     assert(nr_free==CHECK_VALID_PHY_PAGE_NUM);
ffffffffc0202bd4:	0104ac03          	lw	s8,16(s1)
ffffffffc0202bd8:	4791                	li	a5,4
ffffffffc0202bda:	4afc1463          	bne	s8,a5,ffffffffc0203082 <swap_init+0x64a>
     
     cprintf("set up init env for check_swap begin!\n");
ffffffffc0202bde:	00003517          	auipc	a0,0x3
ffffffffc0202be2:	d9a50513          	addi	a0,a0,-614 # ffffffffc0205978 <commands+0x1328>
ffffffffc0202be6:	cd4fd0ef          	jal	ra,ffffffffc02000ba <cprintf>
     *(unsigned char *)0x1000 = 0x0a;
ffffffffc0202bea:	6605                	lui	a2,0x1
     ...
     pgfault_num=0;
ffffffffc0202bec:	0000f797          	auipc	a5,0xf
ffffffffc0202bf0:	9407ae23          	sw	zero,-1700(a5) # ffffffffc0211548 <pgfault_num>
     *(unsigned char *)0x1000 = 0x0a;
ffffffffc0202bf4:	4529                	li	a0,10
ffffffffc0202bf6:	00a60023          	sb	a0,0(a2) # 1000 <kern_entry-0xffffffffc01ff000>
     assert(pgfault_num==1);
ffffffffc0202bfa:	0000f597          	auipc	a1,0xf
ffffffffc0202bfe:	94e5a583          	lw	a1,-1714(a1) # ffffffffc0211548 <pgfault_num>
ffffffffc0202c02:	4805                	li	a6,1
ffffffffc0202c04:	0000f797          	auipc	a5,0xf
ffffffffc0202c08:	94478793          	addi	a5,a5,-1724 # ffffffffc0211548 <pgfault_num>
ffffffffc0202c0c:	3f059b63          	bne	a1,a6,ffffffffc0203002 <swap_init+0x5ca>
     *(unsigned char *)0x1010 = 0x0a;
ffffffffc0202c10:	00a60823          	sb	a0,16(a2)
     assert(pgfault_num==1);
ffffffffc0202c14:	4390                	lw	a2,0(a5)
ffffffffc0202c16:	2601                	sext.w	a2,a2
ffffffffc0202c18:	40b61563          	bne	a2,a1,ffffffffc0203022 <swap_init+0x5ea>
     *(unsigned char *)0x2000 = 0x0b;
ffffffffc0202c1c:	6589                	lui	a1,0x2
ffffffffc0202c1e:	452d                	li	a0,11
ffffffffc0202c20:	00a58023          	sb	a0,0(a1) # 2000 <kern_entry-0xffffffffc01fe000>
     assert(pgfault_num==2);
ffffffffc0202c24:	4390                	lw	a2,0(a5)
ffffffffc0202c26:	4809                	li	a6,2
ffffffffc0202c28:	2601                	sext.w	a2,a2
ffffffffc0202c2a:	35061c63          	bne	a2,a6,ffffffffc0202f82 <swap_init+0x54a>
     *(unsigned char *)0x2010 = 0x0b;
ffffffffc0202c2e:	00a58823          	sb	a0,16(a1)
     assert(pgfault_num==2);
ffffffffc0202c32:	438c                	lw	a1,0(a5)
ffffffffc0202c34:	2581                	sext.w	a1,a1
ffffffffc0202c36:	36c59663          	bne	a1,a2,ffffffffc0202fa2 <swap_init+0x56a>
     *(unsigned char *)0x3000 = 0x0c;
ffffffffc0202c3a:	658d                	lui	a1,0x3
ffffffffc0202c3c:	4531                	li	a0,12
ffffffffc0202c3e:	00a58023          	sb	a0,0(a1) # 3000 <kern_entry-0xffffffffc01fd000>
     assert(pgfault_num==3);
ffffffffc0202c42:	4390                	lw	a2,0(a5)
ffffffffc0202c44:	480d                	li	a6,3
ffffffffc0202c46:	2601                	sext.w	a2,a2
ffffffffc0202c48:	37061d63          	bne	a2,a6,ffffffffc0202fc2 <swap_init+0x58a>
     *(unsigned char *)0x3010 = 0x0c;
ffffffffc0202c4c:	00a58823          	sb	a0,16(a1)
     assert(pgfault_num==3);
ffffffffc0202c50:	438c                	lw	a1,0(a5)
ffffffffc0202c52:	2581                	sext.w	a1,a1
ffffffffc0202c54:	38c59763          	bne	a1,a2,ffffffffc0202fe2 <swap_init+0x5aa>
     *(unsigned char *)0x4000 = 0x0d;
ffffffffc0202c58:	6591                	lui	a1,0x4
ffffffffc0202c5a:	4535                	li	a0,13
ffffffffc0202c5c:	00a58023          	sb	a0,0(a1) # 4000 <kern_entry-0xffffffffc01fc000>
     assert(pgfault_num==4);
ffffffffc0202c60:	4390                	lw	a2,0(a5)
ffffffffc0202c62:	2601                	sext.w	a2,a2
ffffffffc0202c64:	21861f63          	bne	a2,s8,ffffffffc0202e82 <swap_init+0x44a>
     *(unsigned char *)0x4010 = 0x0d;
ffffffffc0202c68:	00a58823          	sb	a0,16(a1)
     assert(pgfault_num==4);
ffffffffc0202c6c:	439c                	lw	a5,0(a5)
ffffffffc0202c6e:	2781                	sext.w	a5,a5
ffffffffc0202c70:	22c79963          	bne	a5,a2,ffffffffc0202ea2 <swap_init+0x46a>
     
     check_content_set();
     assert( nr_free == 0);         
ffffffffc0202c74:	489c                	lw	a5,16(s1)
ffffffffc0202c76:	24079663          	bnez	a5,ffffffffc0202ec2 <swap_init+0x48a>
ffffffffc0202c7a:	0000e797          	auipc	a5,0xe
ffffffffc0202c7e:	41678793          	addi	a5,a5,1046 # ffffffffc0211090 <swap_in_seq_no>
ffffffffc0202c82:	0000e617          	auipc	a2,0xe
ffffffffc0202c86:	43660613          	addi	a2,a2,1078 # ffffffffc02110b8 <swap_out_seq_no>
ffffffffc0202c8a:	0000e517          	auipc	a0,0xe
ffffffffc0202c8e:	42e50513          	addi	a0,a0,1070 # ffffffffc02110b8 <swap_out_seq_no>
     for(i = 0; i<MAX_SEQ_NO ; i++) 
         swap_out_seq_no[i]=swap_in_seq_no[i]=-1;
ffffffffc0202c92:	55fd                	li	a1,-1
ffffffffc0202c94:	c38c                	sw	a1,0(a5)
ffffffffc0202c96:	c20c                	sw	a1,0(a2)
     for(i = 0; i<MAX_SEQ_NO ; i++) 
ffffffffc0202c98:	0791                	addi	a5,a5,4
ffffffffc0202c9a:	0611                	addi	a2,a2,4
ffffffffc0202c9c:	fef51ce3          	bne	a0,a5,ffffffffc0202c94 <swap_init+0x25c>
ffffffffc0202ca0:	0000e817          	auipc	a6,0xe
ffffffffc0202ca4:	3b080813          	addi	a6,a6,944 # ffffffffc0211050 <check_ptep>
ffffffffc0202ca8:	0000e897          	auipc	a7,0xe
ffffffffc0202cac:	3c888893          	addi	a7,a7,968 # ffffffffc0211070 <check_rp>
ffffffffc0202cb0:	6585                	lui	a1,0x1
    return &pages[PPN(pa) - nbase];
ffffffffc0202cb2:	0000fc97          	auipc	s9,0xf
ffffffffc0202cb6:	876c8c93          	addi	s9,s9,-1930 # ffffffffc0211528 <pages>
ffffffffc0202cba:	00003c17          	auipc	s8,0x3
ffffffffc0202cbe:	50ec0c13          	addi	s8,s8,1294 # ffffffffc02061c8 <nbase>
     
     for (i= 0;i<CHECK_VALID_PHY_PAGE_NUM;i++) {
         check_ptep[i]=0;
ffffffffc0202cc2:	00083023          	sd	zero,0(a6)
         check_ptep[i] = get_pte(pgdir, (i+1)*0x1000, 0);
ffffffffc0202cc6:	4601                	li	a2,0
ffffffffc0202cc8:	855e                	mv	a0,s7
ffffffffc0202cca:	ec46                	sd	a7,24(sp)
ffffffffc0202ccc:	e82e                	sd	a1,16(sp)
         check_ptep[i]=0;
ffffffffc0202cce:	e442                	sd	a6,8(sp)
         check_ptep[i] = get_pte(pgdir, (i+1)*0x1000, 0);
ffffffffc0202cd0:	f25fd0ef          	jal	ra,ffffffffc0200bf4 <get_pte>
ffffffffc0202cd4:	6822                	ld	a6,8(sp)
         //cprintf("i %d, check_ptep addr %x, value %x\n", i, check_ptep[i], *check_ptep[i]);
         assert(check_ptep[i] != NULL);
ffffffffc0202cd6:	65c2                	ld	a1,16(sp)
ffffffffc0202cd8:	68e2                	ld	a7,24(sp)
         check_ptep[i] = get_pte(pgdir, (i+1)*0x1000, 0);
ffffffffc0202cda:	00a83023          	sd	a0,0(a6)
         assert(check_ptep[i] != NULL);
ffffffffc0202cde:	0000f317          	auipc	t1,0xf
ffffffffc0202ce2:	84230313          	addi	t1,t1,-1982 # ffffffffc0211520 <npage>
ffffffffc0202ce6:	16050e63          	beqz	a0,ffffffffc0202e62 <swap_init+0x42a>
         assert(pte2page(*check_ptep[i]) == check_rp[i]);
ffffffffc0202cea:	611c                	ld	a5,0(a0)
    if (!(pte & PTE_V)) {
ffffffffc0202cec:	0017f613          	andi	a2,a5,1
ffffffffc0202cf0:	0e060563          	beqz	a2,ffffffffc0202dda <swap_init+0x3a2>
    if (PPN(pa) >= npage) {
ffffffffc0202cf4:	00033603          	ld	a2,0(t1)
    return pa2page(PTE_ADDR(pte));
ffffffffc0202cf8:	078a                	slli	a5,a5,0x2
ffffffffc0202cfa:	83b1                	srli	a5,a5,0xc
    if (PPN(pa) >= npage) {
ffffffffc0202cfc:	0ec7fb63          	bgeu	a5,a2,ffffffffc0202df2 <swap_init+0x3ba>
    return &pages[PPN(pa) - nbase];
ffffffffc0202d00:	000c3603          	ld	a2,0(s8)
ffffffffc0202d04:	000cb503          	ld	a0,0(s9)
ffffffffc0202d08:	0008bf03          	ld	t5,0(a7)
ffffffffc0202d0c:	8f91                	sub	a5,a5,a2
ffffffffc0202d0e:	00379613          	slli	a2,a5,0x3
ffffffffc0202d12:	97b2                	add	a5,a5,a2
ffffffffc0202d14:	078e                	slli	a5,a5,0x3
ffffffffc0202d16:	97aa                	add	a5,a5,a0
ffffffffc0202d18:	0aff1163          	bne	t5,a5,ffffffffc0202dba <swap_init+0x382>
     for (i= 0;i<CHECK_VALID_PHY_PAGE_NUM;i++) {
ffffffffc0202d1c:	6785                	lui	a5,0x1
ffffffffc0202d1e:	95be                	add	a1,a1,a5
ffffffffc0202d20:	6795                	lui	a5,0x5
ffffffffc0202d22:	0821                	addi	a6,a6,8
ffffffffc0202d24:	08a1                	addi	a7,a7,8
ffffffffc0202d26:	f8f59ee3          	bne	a1,a5,ffffffffc0202cc2 <swap_init+0x28a>
         assert((*check_ptep[i] & PTE_V));          
     }
     cprintf("set up init env for check_swap over!\n");
ffffffffc0202d2a:	00003517          	auipc	a0,0x3
ffffffffc0202d2e:	cf650513          	addi	a0,a0,-778 # ffffffffc0205a20 <commands+0x13d0>
ffffffffc0202d32:	b88fd0ef          	jal	ra,ffffffffc02000ba <cprintf>
    int ret = sm->check_swap();
ffffffffc0202d36:	000b3783          	ld	a5,0(s6)
ffffffffc0202d3a:	7f9c                	ld	a5,56(a5)
ffffffffc0202d3c:	9782                	jalr	a5
     // now access the virt pages to test  page relpacement algorithm 
     ret=check_content_access();
     assert(ret==0);
ffffffffc0202d3e:	1a051263          	bnez	a0,ffffffffc0202ee2 <swap_init+0x4aa>
...
ffffffffc0202d46:	4585                	li	a1,1
     for (i=0;i<CHECK_VALID_PHY_PAGE_NUM;i++) {
ffffffffc0202d48:	0921                	addi	s2,s2,8
         free_pages(check_rp[i],1);
ffffffffc0202d4a:	e31fd0ef          	jal	ra,ffffffffc0200b7a <free_pages>
     for (i=0;i<CHECK_VALID_PHY_PAGE_NUM;i++) {
ffffffffc0202d4e:	ff491ae3          	bne	s2,s4,ffffffffc0202d42 <swap_init+0x30a>
     } 

     //free_page(pte2page(*temp_ptep));
     
     mm_destroy(mm);
ffffffffc0202d52:	8556                	mv	a0,s5
ffffffffc0202d54:	a98ff0ef          	jal	ra,ffffffffc0201fec <mm_destroy>
         
     nr_free = nr_free_store;
ffffffffc0202d58:	77a2                	ld	a5,40(sp)
     free_list = free_list_store;
ffffffffc0202d5a:	01b4b423          	sd	s11,8(s1)
     nr_free = nr_free_store;
ffffffffc0202d5e:	c89c                	sw	a5,16(s1)
     free_list = free_list_store;
ffffffffc0202d60:	7782                	ld	a5,32(sp)
ffffffffc0202d62:	e09c                	sd	a5,0(s1)

     
     le = &free_list;
     while ((le = list_next(le)) != &free_list) {
ffffffffc0202d64:	009d8a63          	beq	s11,s1,ffffffffc0202d78 <swap_init+0x340>
         struct Page *p = le2page(le, page_link);
         count --, total -= p->property;
ffffffffc0202d68:	ff8da783          	lw	a5,-8(s11)
    return listelm->next;
ffffffffc0202d6c:	008dbd83          	ld	s11,8(s11)
ffffffffc0202d70:	3d7d                	addiw	s10,s10,-1
ffffffffc0202d72:	9c1d                	subw	s0,s0,a5
     while ((le = list_next(le)) != &free_list) {
ffffffffc0202d74:	fe9d9ae3          	bne	s11,s1,ffffffffc0202d68 <swap_init+0x330>
     }
     cprintf("count is %d, total is %d\n",count,total);
ffffffffc0202d78:	8622                	mv	a2,s0
ffffffffc0202d7a:	85ea                	mv	a1,s10
ffffffffc0202d7c:	00003517          	auipc	a0,0x3
ffffffffc0202d80:	cd450513          	addi	a0,a0,-812 # ffffffffc0205a50 <commands+0x1400>
ffffffffc0202d84:	b36fd0ef          	jal	ra,ffffffffc02000ba <cprintf>
     //assert(count == 0);
     
     cprintf("check_swap() succeeded!\n");
ffffffffc0202d88:	00003517          	auipc	a0,0x3
ffffffffc0202d8c:	ce850513          	addi	a0,a0,-792 # ffffffffc0205a70 <commands+0x1420>
ffffffffc0202d90:	b2afd0ef          	jal	ra,ffffffffc02000ba <cprintf>
}
ffffffffc0202d94:	b9dd                	j	ffffffffc0202a8a <swap_init+0x52>
     while ((le = list_next(le)) != &free_list) {
ffffffffc0202d96:	4901                	li	s2,0
ffffffffc0202d98:	bba9                	j	ffffffffc0202af2 <swap_init+0xba>
        assert(PageProperty(p));
ffffffffc0202d9a:	00003697          	auipc	a3,0x3
ffffffffc0202d9e:	a9668693          	addi	a3,a3,-1386 # ffffffffc0205830 <commands+0x11e0>
ffffffffc0202da2:	00002617          	auipc	a2,0x2
ffffffffc0202da6:	13660613          	addi	a2,a2,310 # ffffffffc0204ed8 <commands+0x888>
ffffffffc0202daa:	0bb00593          	li	a1,187
ffffffffc0202dae:	00003517          	auipc	a0,0x3
ffffffffc0202db2:	a5a50513          	addi	a0,a0,-1446 # ffffffffc0205808 <commands+0x11b8>
ffffffffc0202db6:	b4cfd0ef          	jal	ra,ffffffffc0200102 <__panic>
         assert(pte2page(*check_ptep[i]) == check_rp[i]);
ffffffffc0202dba:	00003697          	auipc	a3,0x3
ffffffffc0202dbe:	c3e68693          	addi	a3,a3,-962 # ffffffffc02059f8 <commands+0x13a8>
ffffffffc0202dc2:	00002617          	auipc	a2,0x2
ffffffffc0202dc6:	11660613          	addi	a2,a2,278 # ffffffffc0204ed8 <commands+0x888>
ffffffffc0202dca:	0fb00593          	li	a1,251
ffffffffc0202dce:	00003517          	auipc	a0,0x3
ffffffffc0202dd2:	a3a50513          	addi	a0,a0,-1478 # ffffffffc0205808 <commands+0x11b8>
ffffffffc0202dd6:	b2cfd0ef          	jal	ra,ffffffffc0200102 <__panic>
        panic("pte2page called with invalid pte");
ffffffffc0202dda:	00002617          	auipc	a2,0x2
ffffffffc0202dde:	fae60613          	addi	a2,a2,-82 # ffffffffc0204d88 <commands+0x738>
ffffffffc0202de2:	07000593          	li	a1,112
ffffffffc0202de6:	00002517          	auipc	a0,0x2
ffffffffc0202dea:	f9250513          	addi	a0,a0,-110 # ffffffffc0204d78 <commands+0x728>
ffffffffc0202dee:	b14fd0ef          	jal	ra,ffffffffc0200102 <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0202df2:	00002617          	auipc	a2,0x2
ffffffffc0202df6:	f6660613          	addi	a2,a2,-154 # ffffffffc0204d58 <commands+0x708>
ffffffffc0202dfa:	06500593          	li	a1,101
ffffffffc0202dfe:	00002517          	auipc	a0,0x2
ffffffffc0202e02:	f7a50513          	addi	a0,a0,-134 # ffffffffc0204d78 <commands+0x728>
ffffffffc0202e06:	afcfd0ef          	jal	ra,ffffffffc0200102 <__panic>
          assert(!PageProperty(check_rp[i]));
ffffffffc0202e0a:	00003697          	auipc	a3,0x3
ffffffffc0202e0e:	b2668693          	addi	a3,a3,-1242 # ffffffffc0205930 <commands+0x12e0>
ffffffffc0202e12:	00002617          	auipc	a2,0x2
ffffffffc0202e16:	0c660613          	addi	a2,a2,198 # ffffffffc0204ed8 <commands+0x888>
ffffffffc0202e1a:	0dc00593          	li	a1,220
ffffffffc0202e1e:	00003517          	auipc	a0,0x3
ffffffffc0202e22:	9ea50513          	addi	a0,a0,-1558 # ffffffffc0205808 <commands+0x11b8>
ffffffffc0202e26:	adcfd0ef          	jal	ra,ffffffffc0200102 <__panic>
          assert(check_rp[i] != NULL );
ffffffffc0202e2a:	00003697          	auipc	a3,0x3
ffffffffc0202e2e:	aee68693          	addi	a3,a3,-1298 # ffffffffc0205918 <commands+0x12c8>
ffffffffc0202e32:	00002617          	auipc	a2,0x2
ffffffffc0202e36:	0a660613          	addi	a2,a2,166 # ffffffffc0204ed8 <commands+0x888>
ffffffffc0202e3a:	0db00593          	li	a1,219
ffffffffc0202e3e:	00003517          	auipc	a0,0x3
ffffffffc0202e42:	9ca50513          	addi	a0,a0,-1590 # ffffffffc0205808 <commands+0x11b8>
ffffffffc0202e46:	abcfd0ef          	jal	ra,ffffffffc0200102 <__panic>
        panic("bad max_swap_offset %08x.\n", max_swap_offset);
ffffffffc0202e4a:	00003617          	auipc	a2,0x3
ffffffffc0202e4e:	99e60613          	addi	a2,a2,-1634 # ffffffffc02057e8 <commands+0x1198>
ffffffffc0202e52:	02800593          	li	a1,40
ffffffffc0202e56:	00003517          	auipc	a0,0x3
ffffffffc0202e5a:	9b250513          	addi	a0,a0,-1614 # ffffffffc0205808 <commands+0x11b8>
ffffffffc0202e5e:	aa4fd0ef          	jal	ra,ffffffffc0200102 <__panic>
         assert(check_ptep[i] != NULL);
ffffffffc0202e62:	00003697          	auipc	a3,0x3
ffffffffc0202e66:	b7e68693          	addi	a3,a3,-1154 # ffffffffc02059e0 <commands+0x1390>
ffffffffc0202e6a:	00002617          	auipc	a2,0x2
ffffffffc0202e6e:	06e60613          	addi	a2,a2,110 # ffffffffc0204ed8 <commands+0x888>
ffffffffc0202e72:	0fa00593          	li	a1,250
ffffffffc0202e76:	00003517          	auipc	a0,0x3
ffffffffc0202e7a:	99250513          	addi	a0,a0,-1646 # ffffffffc0205808 <commands+0x11b8>
ffffffffc0202e7e:	a84fd0ef          	jal	ra,ffffffffc0200102 <__panic>
     assert(pgfault_num==4);
ffffffffc0202e82:	00003697          	auipc	a3,0x3
ffffffffc0202e86:	88668693          	addi	a3,a3,-1914 # ffffffffc0205708 <commands+0x10b8>
ffffffffc0202e8a:	00002617          	auipc	a2,0x2
ffffffffc0202e8e:	04e60613          	addi	a2,a2,78 # ffffffffc0204ed8 <commands+0x888>
ffffffffc0202e92:	09e00593          	li	a1,158
ffffffffc0202e96:	00003517          	auipc	a0,0x3
ffffffffc0202e9a:	97250513          	addi	a0,a0,-1678 # ffffffffc0205808 <commands+0x11b8>
ffffffffc0202e9e:	a64fd0ef          	jal	ra,ffffffffc0200102 <__panic>
     assert(pgfault_num==4);
ffffffffc0202ea2:	00003697          	auipc	a3,0x3
ffffffffc0202ea6:	86668693          	addi	a3,a3,-1946 # ffffffffc0205708 <commands+0x10b8>
ffffffffc0202eaa:	00002617          	auipc	a2,0x2
ffffffffc0202eae:	02e60613          	addi	a2,a2,46 # ffffffffc0204ed8 <commands+0x888>
ffffffffc0202eb2:	0a000593          	li	a1,160
ffffffffc0202eb6:	00003517          	auipc	a0,0x3
ffffffffc0202eba:	95250513          	addi	a0,a0,-1710 # ffffffffc0205808 <commands+0x11b8>
ffffffffc0202ebe:	a44fd0ef          	jal	ra,ffffffffc0200102 <__panic>
     assert( nr_free == 0);         
ffffffffc0202ec2:	00003697          	auipc	a3,0x3
ffffffffc0202ec6:	b0e68693          	addi	a3,a3,-1266 # ffffffffc02059d0 <commands+0x1380>
ffffffffc0202eca:	00002617          	auipc	a2,0x2
ffffffffc0202ece:	00e60613          	addi	a2,a2,14 # ffffffffc0204ed8 <commands+0x888>
ffffffffc0202ed2:	0f200593          	li	a1,242
ffffffffc0202ed6:	00003517          	auipc	a0,0x3
ffffffffc0202eda:	93250513          	addi	a0,a0,-1742 # ffffffffc0205808 <commands+0x11b8>
ffffffffc0202ede:	a24fd0ef          	jal	ra,ffffffffc0200102 <__panic>
     assert(ret==0);
ffffffffc0202ee2:	00003697          	auipc	a3,0x3
ffffffffc0202ee6:	b6668693          	addi	a3,a3,-1178 # ffffffffc0205a48 <commands+0x13f8>
ffffffffc0202eea:	00002617          	auipc	a2,0x2
ffffffffc0202eee:	fee60613          	addi	a2,a2,-18 # ffffffffc0204ed8 <commands+0x888>
ffffffffc0202ef2:	10100593          	li	a1,257
ffffffffc0202ef6:	00003517          	auipc	a0,0x3
ffffffffc0202efa:	91250513          	addi	a0,a0,-1774 # ffffffffc0205808 <commands+0x11b8>
ffffffffc0202efe:	a04fd0ef          	jal	ra,ffffffffc0200102 <__panic>
     assert(pgdir[0] == 0);
ffffffffc0202f02:	00002697          	auipc	a3,0x2
ffffffffc0202f06:	6d668693          	addi	a3,a3,1750 # ffffffffc02055d8 <commands+0xf88>
ffffffffc0202f0a:	00002617          	auipc	a2,0x2
ffffffffc0202f0e:	fce60613          	addi	a2,a2,-50 # ffffffffc0204ed8 <commands+0x888>
ffffffffc0202f12:	0cb00593          	li	a1,203
ffffffffc0202f16:	00003517          	auipc	a0,0x3
ffffffffc0202f1a:	8f250513          	addi	a0,a0,-1806 # ffffffffc0205808 <commands+0x11b8>
ffffffffc0202f1e:	9e4fd0ef          	jal	ra,ffffffffc0200102 <__panic>
     assert(vma != NULL);
ffffffffc0202f22:	00002697          	auipc	a3,0x2
ffffffffc0202f26:	72e68693          	addi	a3,a3,1838 # ffffffffc0205650 <commands+0x1000>
ffffffffc0202f2a:	00002617          	auipc	a2,0x2
ffffffffc0202f2e:	fae60613          	addi	a2,a2,-82 # ffffffffc0204ed8 <commands+0x888>
ffffffffc0202f32:	0ce00593          	li	a1,206
ffffffffc0202f36:	00003517          	auipc	a0,0x3
ffffffffc0202f3a:	8d250513          	addi	a0,a0,-1838 # ffffffffc0205808 <commands+0x11b8>
ffffffffc0202f3e:	9c4fd0ef          	jal	ra,ffffffffc0200102 <__panic>
     assert(temp_ptep!= NULL);
ffffffffc0202f42:	00003697          	auipc	a3,0x3
ffffffffc0202f46:	99668693          	addi	a3,a3,-1642 # ffffffffc02058d8 <commands+0x1288>
ffffffffc0202f4a:	00002617          	auipc	a2,0x2
ffffffffc0202f4e:	f8e60613          	addi	a2,a2,-114 # ffffffffc0204ed8 <commands+0x888>
ffffffffc0202f52:	0d600593          	li	a1,214
ffffffffc0202f56:	00003517          	auipc	a0,0x3
ffffffffc0202f5a:	8b250513          	addi	a0,a0,-1870 # ffffffffc0205808 <commands+0x11b8>
ffffffffc0202f5e:	9a4fd0ef          	jal	ra,ffffffffc0200102 <__panic>
     assert(total == nr_free_pages());
ffffffffc0202f62:	00003697          	auipc	a3,0x3
ffffffffc0202f66:	8de68693          	addi	a3,a3,-1826 # ffffffffc0205840 <commands+0x11f0>
ffffffffc0202f6a:	00002617          	auipc	a2,0x2
ffffffffc0202f6e:	f6e60613          	addi	a2,a2,-146 # ffffffffc0204ed8 <commands+0x888>
ffffffffc0202f72:	0be00593          	li	a1,190
ffffffffc0202f76:	00003517          	auipc	a0,0x3
ffffffffc0202f7a:	89250513          	addi	a0,a0,-1902 # ffffffffc0205808 <commands+0x11b8>
ffffffffc0202f7e:	984fd0ef          	jal	ra,ffffffffc0200102 <__panic>
     assert(pgfault_num==2);
ffffffffc0202f82:	00003697          	auipc	a3,0x3
ffffffffc0202f86:	a2e68693          	addi	a3,a3,-1490 # ffffffffc02059b0 <commands+0x1360>
ffffffffc0202f8a:	00002617          	auipc	a2,0x2
ffffffffc0202f8e:	f4e60613          	addi	a2,a2,-178 # ffffffffc0204ed8 <commands+0x888>
ffffffffc0202f92:	09600593          	li	a1,150
ffffffffc0202f96:	00003517          	auipc	a0,0x3
ffffffffc0202f9a:	87250513          	addi	a0,a0,-1934 # ffffffffc0205808 <commands+0x11b8>
ffffffffc0202f9e:	964fd0ef          	jal	ra,ffffffffc0200102 <__panic>
     assert(pgfault_num==2);
ffffffffc0202fa2:	00003697          	auipc	a3,0x3
ffffffffc0202fa6:	a0e68693          	addi	a3,a3,-1522 # ffffffffc02059b0 <commands+0x1360>
ffffffffc0202faa:	00002617          	auipc	a2,0x2
ffffffffc0202fae:	f2e60613          	addi	a2,a2,-210 # ffffffffc0204ed8 <commands+0x888>
ffffffffc0202fb2:	09800593          	li	a1,152
ffffffffc0202fb6:	00003517          	auipc	a0,0x3
ffffffffc0202fba:	85250513          	addi	a0,a0,-1966 # ffffffffc0205808 <commands+0x11b8>
ffffffffc0202fbe:	944fd0ef          	jal	ra,ffffffffc0200102 <__panic>
     assert(pgfault_num==3);
ffffffffc0202fc2:	00003697          	auipc	a3,0x3
ffffffffc0202fc6:	9fe68693          	addi	a3,a3,-1538 # ffffffffc02059c0 <commands+0x1370>
ffffffffc0202fca:	00002617          	auipc	a2,0x2
ffffffffc0202fce:	f0e60613          	addi	a2,a2,-242 # ffffffffc0204ed8 <commands+0x888>
ffffffffc0202fd2:	09a00593          	li	a1,154
ffffffffc0202fd6:	00003517          	auipc	a0,0x3
ffffffffc0202fda:	83250513          	addi	a0,a0,-1998 # ffffffffc0205808 <commands+0x11b8>
ffffffffc0202fde:	924fd0ef          	jal	ra,ffffffffc0200102 <__panic>
     assert(pgfault_num==3);
ffffffffc0202fe2:	00003697          	auipc	a3,0x3
ffffffffc0202fe6:	9de68693          	addi	a3,a3,-1570 # ffffffffc02059c0 <commands+0x1370>
ffffffffc0202fea:	00002617          	auipc	a2,0x2
ffffffffc0202fee:	eee60613          	addi	a2,a2,-274 # ffffffffc0204ed8 <commands+0x888>
ffffffffc0202ff2:	09c00593          	li	a1,156
ffffffffc0202ff6:	00003517          	auipc	a0,0x3
ffffffffc0202ffa:	81250513          	addi	a0,a0,-2030 # ffffffffc0205808 <commands+0x11b8>
ffffffffc0202ffe:	904fd0ef          	jal	ra,ffffffffc0200102 <__panic>
     assert(pgfault_num==1);
ffffffffc0203002:	00003697          	auipc	a3,0x3
ffffffffc0203006:	99e68693          	addi	a3,a3,-1634 # ffffffffc02059a0 <commands+0x1350>
ffffffffc020300a:	00002617          	auipc	a2,0x2
ffffffffc020300e:	ece60613          	addi	a2,a2,-306 # ffffffffc0204ed8 <commands+0x888>
ffffffffc0203012:	09200593          	li	a1,146
ffffffffc0203016:	00002517          	auipc	a0,0x2
ffffffffc020301a:	7f250513          	addi	a0,a0,2034 # ffffffffc0205808 <commands+0x11b8>
ffffffffc020301e:	8e4fd0ef          	jal	ra,ffffffffc0200102 <__panic>
     assert(pgfault_num==1);
ffffffffc0203022:	00003697          	auipc	a3,0x3
ffffffffc0203026:	97e68693          	addi	a3,a3,-1666 # ffffffffc02059a0 <commands+0x1350>
ffffffffc020302a:	00002617          	auipc	a2,0x2
ffffffffc020302e:	eae60613          	addi	a2,a2,-338 # ffffffffc0204ed8 <commands+0x888>
ffffffffc0203032:	09400593          	li	a1,148
ffffffffc0203036:	00002517          	auipc	a0,0x2
ffffffffc020303a:	7d250513          	addi	a0,a0,2002 # ffffffffc0205808 <commands+0x11b8>
ffffffffc020303e:	8c4fd0ef          	jal	ra,ffffffffc0200102 <__panic>
     assert(mm != NULL);
ffffffffc0203042:	00002697          	auipc	a3,0x2
ffffffffc0203046:	63668693          	addi	a3,a3,1590 # ffffffffc0205678 <commands+0x1028>
ffffffffc020304a:	00002617          	auipc	a2,0x2
ffffffffc020304e:	e8e60613          	addi	a2,a2,-370 # ffffffffc0204ed8 <commands+0x888>
ffffffffc0203052:	0c300593          	li	a1,195
ffffffffc0203056:	00002517          	auipc	a0,0x2
ffffffffc020305a:	7b250513          	addi	a0,a0,1970 # ffffffffc0205808 <commands+0x11b8>
ffffffffc020305e:	8a4fd0ef          	jal	ra,ffffffffc0200102 <__panic>
     assert(check_mm_struct == NULL);
ffffffffc0203062:	00003697          	auipc	a3,0x3
ffffffffc0203066:	82668693          	addi	a3,a3,-2010 # ffffffffc0205888 <commands+0x1238>
ffffffffc020306a:	00002617          	auipc	a2,0x2
ffffffffc020306e:	e6e60613          	addi	a2,a2,-402 # ffffffffc0204ed8 <commands+0x888>
ffffffffc0203072:	0c600593          	li	a1,198
ffffffffc0203076:	00002517          	auipc	a0,0x2
ffffffffc020307a:	79250513          	addi	a0,a0,1938 # ffffffffc0205808 <commands+0x11b8>
ffffffffc020307e:	884fd0ef          	jal	ra,ffffffffc0200102 <__panic>
     assert(nr_free==CHECK_VALID_PHY_PAGE_NUM);
ffffffffc0203082:	00003697          	auipc	a3,0x3
ffffffffc0203086:	8ce68693          	addi	a3,a3,-1842 # ffffffffc0205950 <commands+0x1300>
ffffffffc020308a:	00002617          	auipc	a2,0x2
ffffffffc020308e:	e4e60613          	addi	a2,a2,-434 # ffffffffc0204ed8 <commands+0x888>
ffffffffc0203092:	0e900593          	li	a1,233
ffffffffc0203096:	00002517          	auipc	a0,0x2
ffffffffc020309a:	77250513          	addi	a0,a0,1906 # ffffffffc0205808 <commands+0x11b8>
ffffffffc020309e:	864fd0ef          	jal	ra,ffffffffc0200102 <__panic>

ffffffffc02030a2 <swap_init_mm>:
     return sm->init_mm(mm);
ffffffffc02030a2:	0000e797          	auipc	a5,0xe
ffffffffc02030a6:	4be7b783          	ld	a5,1214(a5) # ffffffffc0211560 <sm>
ffffffffc02030aa:	6b9c                	ld	a5,16(a5)
ffffffffc02030ac:	8782                	jr	a5

ffffffffc02030ae <swap_map_swappable>:
     return sm->map_swappable(mm, addr, page, swap_in);
ffffffffc02030ae:	0000e797          	auipc	a5,0xe
ffffffffc02030b2:	4b27b783          	ld	a5,1202(a5) # ffffffffc0211560 <sm>
ffffffffc02030b6:	739c                	ld	a5,32(a5)
ffffffffc02030b8:	8782                	jr	a5

ffffffffc02030ba <swap_out>:
{
ffffffffc02030ba:	711d                	addi	sp,sp,-96
ffffffffc02030bc:	ec86                	sd	ra,88(sp)
ffffffffc02030be:	e8a2                	sd	s0,80(sp)
ffffffffc02030c0:	e4a6                	sd	s1,72(sp)
ffffffffc02030c2:	e0ca                	sd	s2,64(sp)
ffffffffc02030c4:	fc4e                	sd	s3,56(sp)
ffffffffc02030c6:	f852                	sd	s4,48(sp)
ffffffffc02030c8:	f456                	sd	s5,40(sp)
ffffffffc02030ca:	f05a                	sd	s6,32(sp)
ffffffffc02030cc:	ec5e                	sd	s7,24(sp)
ffffffffc02030ce:	e862                	sd	s8,16(sp)
     for (i = 0; i != n; ++ i)
ffffffffc02030d0:	cde9                	beqz	a1,ffffffffc02031aa <swap_out+0xf0>
ffffffffc02030d2:	8a2e                	mv	s4,a1
ffffffffc02030d4:	892a                	mv	s2,a0
ffffffffc02030d6:	8ab2                	mv	s5,a2
ffffffffc02030d8:	4401                	li	s0,0
ffffffffc02030da:	0000e997          	auipc	s3,0xe
ffffffffc02030de:	48698993          	addi	s3,s3,1158 # ffffffffc0211560 <sm>
                    cprintf("swap_out: i %d, store page in vaddr 0x%x to disk swap entry %d\n", i, v, page->pra_vaddr/PGSIZE+1);
ffffffffc02030e2:	00003b17          	auipc	s6,0x3
ffffffffc02030e6:	a0eb0b13          	addi	s6,s6,-1522 # ffffffffc0205af0 <commands+0x14a0>
                    cprintf("SWAP: failed to save\n");
ffffffffc02030ea:	00003b97          	auipc	s7,0x3
ffffffffc02030ee:	9eeb8b93          	addi	s7,s7,-1554 # ffffffffc0205ad8 <commands+0x1488>
ffffffffc02030f2:	a825                	j	ffffffffc020312a <swap_out+0x70>
                    cprintf("swap_out: i %d, store page in vaddr 0x%x to disk swap entry %d\n", i, v, page->pra_vaddr/PGSIZE+1);
ffffffffc02030f4:	67a2                	ld	a5,8(sp)
ffffffffc02030f6:	8626                	mv	a2,s1
ffffffffc02030f8:	85a2                	mv	a1,s0
ffffffffc02030fa:	63b4                	ld	a3,64(a5)
ffffffffc02030fc:	855a                	mv	a0,s6
     for (i = 0; i != n; ++ i)
ffffffffc02030fe:	2405                	addiw	s0,s0,1
                    cprintf("swap_out: i %d, store page in vaddr 0x%x to disk swap entry %d\n", i, v, page->pra_vaddr/PGSIZE+1);
ffffffffc0203100:	82b1                	srli	a3,a3,0xc
ffffffffc0203102:	0685                	addi	a3,a3,1
ffffffffc0203104:	fb7fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
                    *ptep = (page->pra_vaddr/PGSIZE+1)<<8;
ffffffffc0203108:	6522                	ld	a0,8(sp)
                    free_page(page);
ffffffffc020310a:	4585                	li	a1,1
                    *ptep = (page->pra_vaddr/PGSIZE+1)<<8;
ffffffffc020310c:	613c                	ld	a5,64(a0)
ffffffffc020310e:	83b1                	srli	a5,a5,0xc
ffffffffc0203110:	0785                	addi	a5,a5,1
ffffffffc0203112:	07a2                	slli	a5,a5,0x8
ffffffffc0203114:	00fc3023          	sd	a5,0(s8)
                    free_page(page);
ffffffffc0203118:	a63fd0ef          	jal	ra,ffffffffc0200b7a <free_pages>
          tlb_invalidate(mm->pgdir, v);
ffffffffc020311c:	01893503          	ld	a0,24(s2)
ffffffffc0203120:	85a6                	mv	a1,s1
ffffffffc0203122:	ac1fe0ef          	jal	ra,ffffffffc0201be2 <tlb_invalidate>
     for (i = 0; i != n; ++ i)
ffffffffc0203126:	048a0d63          	beq	s4,s0,ffffffffc0203180 <swap_out+0xc6>
          int r = sm->swap_out_victim(mm, &page, in_tick);
ffffffffc020312a:	0009b783          	ld	a5,0(s3)
ffffffffc020312e:	8656                	mv	a2,s5
ffffffffc0203130:	002c                	addi	a1,sp,8
ffffffffc0203132:	7b9c                	ld	a5,48(a5)
ffffffffc0203134:	854a                	mv	a0,s2
ffffffffc0203136:	9782                	jalr	a5
          if (r != 0) {
ffffffffc0203138:	e12d                	bnez	a0,ffffffffc020319a <swap_out+0xe0>
          v=page->pra_vaddr; 
ffffffffc020313a:	67a2                	ld	a5,8(sp)
          pte_t *ptep = get_pte(mm->pgdir, v, 0);
ffffffffc020313c:	01893503          	ld	a0,24(s2)
ffffffffc0203140:	4601                	li	a2,0
          v=page->pra_vaddr; 
ffffffffc0203142:	63a4                	ld	s1,64(a5)
          pte_t *ptep = get_pte(mm->pgdir, v, 0);
ffffffffc0203144:	85a6                	mv	a1,s1
ffffffffc0203146:	aaffd0ef          	jal	ra,ffffffffc0200bf4 <get_pte>
          assert((*ptep & PTE_V) != 0);
ffffffffc020314a:	611c                	ld	a5,0(a0)
          pte_t *ptep = get_pte(mm->pgdir, v, 0);
ffffffffc020314c:	8c2a                	mv	s8,a0
          assert((*ptep & PTE_V) != 0);
ffffffffc020314e:	8b85                	andi	a5,a5,1
ffffffffc0203150:	cfb9                	beqz	a5,ffffffffc02031ae <swap_out+0xf4>
          if (swapfs_write( (page->pra_vaddr/PGSIZE+1)<<8, page) != 0) {
ffffffffc0203152:	65a2                	ld	a1,8(sp)
ffffffffc0203154:	61bc                	ld	a5,64(a1)
ffffffffc0203156:	83b1                	srli	a5,a5,0xc
ffffffffc0203158:	0785                	addi	a5,a5,1
ffffffffc020315a:	00879513          	slli	a0,a5,0x8
ffffffffc020315e:	495000ef          	jal	ra,ffffffffc0203df2 <swapfs_write>
ffffffffc0203162:	d949                	beqz	a0,ffffffffc02030f4 <swap_out+0x3a>
                    cprintf("SWAP: failed to save\n");
ffffffffc0203164:	855e                	mv	a0,s7
ffffffffc0203166:	f55fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
                    sm->map_swappable(mm, v, page, 0);
ffffffffc020316a:	0009b783          	ld	a5,0(s3)
ffffffffc020316e:	6622                	ld	a2,8(sp)
ffffffffc0203170:	4681                	li	a3,0
ffffffffc0203172:	739c                	ld	a5,32(a5)
ffffffffc0203174:	85a6                	mv	a1,s1
ffffffffc0203176:	854a                	mv	a0,s2
     for (i = 0; i != n; ++ i)
ffffffffc0203178:	2405                	addiw	s0,s0,1
                    sm->map_swappable(mm, v, page, 0);
ffffffffc020317a:	9782                	jalr	a5
     for (i = 0; i != n; ++ i)
ffffffffc020317c:	fa8a17e3          	bne	s4,s0,ffffffffc020312a <swap_out+0x70>
}
ffffffffc0203180:	60e6                	ld	ra,88(sp)
ffffffffc0203182:	8522                	mv	a0,s0
ffffffffc0203184:	6446                	ld	s0,80(sp)
ffffffffc0203186:	64a6                	ld	s1,72(sp)
ffffffffc0203188:	6906                	ld	s2,64(sp)
ffffffffc020318a:	79e2                	ld	s3,56(sp)
ffffffffc020318c:	7a42                	ld	s4,48(sp)
ffffffffc020318e:	7aa2                	ld	s5,40(sp)
ffffffffc0203190:	7b02                	ld	s6,32(sp)
ffffffffc0203192:	6be2                	ld	s7,24(sp)
ffffffffc0203194:	6c42                	ld	s8,16(sp)
ffffffffc0203196:	6125                	addi	sp,sp,96
ffffffffc0203198:	8082                	ret
                    cprintf("i %d, swap_out: call swap_out_victim failed\n",i);
ffffffffc020319a:	85a2                	mv	a1,s0
ffffffffc020319c:	00003517          	auipc	a0,0x3
ffffffffc02031a0:	8f450513          	addi	a0,a0,-1804 # ffffffffc0205a90 <commands+0x1440>
ffffffffc02031a4:	f17fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
                  break;
ffffffffc02031a8:	bfe1                	j	ffffffffc0203180 <swap_out+0xc6>
     for (i = 0; i != n; ++ i)
ffffffffc02031aa:	4401                	li	s0,0
ffffffffc02031ac:	bfd1                	j	ffffffffc0203180 <swap_out+0xc6>
          assert((*ptep & PTE_V) != 0);
ffffffffc02031ae:	00003697          	auipc	a3,0x3
ffffffffc02031b2:	91268693          	addi	a3,a3,-1774 # ffffffffc0205ac0 <commands+0x1470>
ffffffffc02031b6:	00002617          	auipc	a2,0x2
ffffffffc02031ba:	d2260613          	addi	a2,a2,-734 # ffffffffc0204ed8 <commands+0x888>
ffffffffc02031be:	06700593          	li	a1,103
ffffffffc02031c2:	00002517          	auipc	a0,0x2
ffffffffc02031c6:	64650513          	addi	a0,a0,1606 # ffffffffc0205808 <commands+0x11b8>
ffffffffc02031ca:	f39fc0ef          	jal	ra,ffffffffc0200102 <__panic>

ffffffffc02031ce <swap_in>:
{
ffffffffc02031ce:	7179                	addi	sp,sp,-48
ffffffffc02031d0:	e84a                	sd	s2,16(sp)
ffffffffc02031d2:	892a                	mv	s2,a0
     struct Page *result = alloc_page();
ffffffffc02031d4:	4505                	li	a0,1
{
ffffffffc02031d6:	ec26                	sd	s1,24(sp)
ffffffffc02031d8:	e44e                	sd	s3,8(sp)
ffffffffc02031da:	f406                	sd	ra,40(sp)
ffffffffc02031dc:	f022                	sd	s0,32(sp)
ffffffffc02031de:	84ae                	mv	s1,a1
ffffffffc02031e0:	89b2                	mv	s3,a2
     struct Page *result = alloc_page();
ffffffffc02031e2:	907fd0ef          	jal	ra,ffffffffc0200ae8 <alloc_pages>
     assert(result!=NULL);
ffffffffc02031e6:	c129                	beqz	a0,ffffffffc0203228 <swap_in+0x5a>
     pte_t *ptep = get_pte(mm->pgdir, addr, 0);
ffffffffc02031e8:	842a                	mv	s0,a0
ffffffffc02031ea:	01893503          	ld	a0,24(s2)
ffffffffc02031ee:	4601                	li	a2,0
ffffffffc02031f0:	85a6                	mv	a1,s1
ffffffffc02031f2:	a03fd0ef          	jal	ra,ffffffffc0200bf4 <get_pte>
ffffffffc02031f6:	892a                	mv	s2,a0
     if ((r = swapfs_read((*ptep), result)) != 0)
ffffffffc02031f8:	6108                	ld	a0,0(a0)
ffffffffc02031fa:	85a2                	mv	a1,s0
ffffffffc02031fc:	35d000ef          	jal	ra,ffffffffc0203d58 <swapfs_read>
     cprintf("swap_in: load disk swap entry %d with swap_page in vadr 0x%x\n", (*ptep)>>8, addr);
ffffffffc0203200:	00093583          	ld	a1,0(s2)
ffffffffc0203204:	8626                	mv	a2,s1
ffffffffc0203206:	00003517          	auipc	a0,0x3
ffffffffc020320a:	93a50513          	addi	a0,a0,-1734 # ffffffffc0205b40 <commands+0x14f0>
ffffffffc020320e:	81a1                	srli	a1,a1,0x8
ffffffffc0203210:	eabfc0ef          	jal	ra,ffffffffc02000ba <cprintf>
}
ffffffffc0203214:	70a2                	ld	ra,40(sp)
     *ptr_result=result;
ffffffffc0203216:	0089b023          	sd	s0,0(s3)
}
...
ffffffffc020322c:	90868693          	addi	a3,a3,-1784 # ffffffffc0205b30 <commands+0x14e0>
ffffffffc0203230:	00002617          	auipc	a2,0x2
ffffffffc0203234:	ca860613          	addi	a2,a2,-856 # ffffffffc0204ed8 <commands+0x888>
ffffffffc0203238:	07d00593          	li	a1,125
ffffffffc020323c:	00002517          	auipc	a0,0x2
ffffffffc0203240:	5cc50513          	addi	a0,a0,1484 # ffffffffc0205808 <commands+0x11b8>
...
ffffffffc020355e:	2d668693          	addi	a3,a3,726 # ffffffffc0205830 <commands+0x11e0>
...
ffffffffc020369e:	33668693          	addi	a3,a3,822 # ffffffffc02059d0 <commands+0x1380>
...
ffffffffc02037be:	21668693          	addi	a3,a3,534 # ffffffffc02059d0 <commands+0x1380>
...
ffffffffc02039be:	e8668693          	addi	a3,a3,-378 # ffffffffc0205840 <commands+0x11f0>
...
ffffffffc0203d3a:	82a7b123          	sd	a0,-2014(a5) # ffffffffc0211558 <max_swap_offset>
}
...
ffffffffc0203d4a:	45bd                	li	a1,15
...
ffffffffc0203d66:	7f673703          	ld	a4,2038(a4) # ffffffffc0211558 <max_swap_offset>
...
ffffffffc0203dca:	45dd                	li	a1,23
...
ffffffffc0203dda:	06a00593          	li	a1,106
...
ffffffffc0203e00:	75c73703          	ld	a4,1884(a4) # ffffffffc0211558 <max_swap_offset>
...
ffffffffc0203e64:	45f1                	li	a1,28
